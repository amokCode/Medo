...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            @include('Categorie.delete_modal')
            @include('Categorie.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('categorie.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('categorie.create') }}" class="btn-nav btn btn-primary pull-right"><i
            ...
            <div class="card card-table">
                <div class="card-header bg-primary">
                    <h4 class="card-title text-center text-light"> Liste des Categories </h4>
                </div>
                <div class="card-body">
                    <div class="">
