...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            @include('Article.delete_modal')
            @include('Article.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('article.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('article.create') }}" class="btn-nav btn btn-primary pull-right"><i
							...
							<td>{{ $article->contenu }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn bg-danger-light btn-sm btn-delete"
                                                data-nom="{{ $article->nom }}" data-id="{{ $article->id }}"
