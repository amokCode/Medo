...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            @include('Verset.deleteAll_modal')
            <div class="form-group text-ridght">
                ...
                <a href="{{ route('verset.index') }}" class="btn bg-warning-light" data-toggle="tooltip"
                ...
                <a href="{{ route('verset.create') }}" class="btn-nav btn btn-primary pull-right"><i
            ...
            <div class="card card-table">
                <div class="card-header bg-primary">
                    <h4 class="card-title text-center text-light"> Liste des Versets </h4>
                </div>
                <div class="card-body">
                    <div class="">
                                ...
                                @foreach ($versets as $verset)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('verset.edit', $verset->id) }}"
                                            ...
                                            <a href="#" class="btn bg-danger-light btn-sm btn-delete"
                                                data-nom="{{ $verset->nom }}" data-id="{{ $verset->id }}"
